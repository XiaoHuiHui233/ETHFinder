...
def get_enr(
    enr_seq: int, ip: IPAddress, port: int, private_key: PrivateKey
) -> bytes:
    content = [
...
SERVICE_INTERVAL = 10
POST_BLOCK_URLS = [
    "http://172.17.0.1:8088/block", "http://block_monitor:8893/block"
]
POST_TICK_URLS = [
    "http://172.17.0.1:8088/balance", "http://tick_server:8889/info"
]
# web service
WEB_ADRESS = "0.0.0.0"
WEB_PORT = 8089
