...
def burn(tick_lower: int, tick_upper: int, amount: int, sqrt_price_X96: int, tick: int) -> Tuple[int, int]:
    amount0_int, amount1_int = modify_position(tick_lower, tick_upper, -amount, sqrt_price_X96, tick)
    amount0 = -amount0_int
    amount1 = -amount1_int
    return(amount0, amount1)